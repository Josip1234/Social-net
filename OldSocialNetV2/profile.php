...
$id1=(isset($_SESSION['id']))?$_SESSION["id"]:0;
$firstname1=(isset($_POST['firstname1']))?$_POST['firstname1']:"";
$lastname1=(isset($_POST['lastname1']))?$_POST['lastname1']:"";
$sex1=(isset($_POST['sex1']))?$_POST['sex1']:"";
$datum1=(isset($_POST["datum1"]))?$_POST['datum1']:"";
$cityofbirth1=(isset($_POST["cityofbirth1"]))?$_POST['cityofbirth1']:"";
$countryofbirth1=(isset($_POST["countryofbirth1"]))?$_POST['countryofbirth1']:"";
$pass1=(isset($_POST['pass1']))?$_POST['pass1']:"";
$email1=(isset($_POST['email1']))?$_POST['email1']:"";
$uloga1=(isset($_POST['uloga1']))?$_POST['uloga1']:"";
echo $id1;
echo $firstname1;
echo $lastname1;
echo $sex1;
