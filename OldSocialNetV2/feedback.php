...
$fname=(isset($_POST["fname"]))?mysqli_real_escape_string($dbc,trim(strip_tags($_POST['fname']))):"";
...
$lname=(isset($_POST["lname"]))?mysqli_real_escape_string($dbc,trim(strip_tags($_POST['lname']))):"";
if($lname!=''){
$suggestions=isset($_POST["suggestions"])?mysqli_real_escape_string($dbc,trim(strip_tags($_POST['suggestions']))):"";
if($suggestions!=''){
