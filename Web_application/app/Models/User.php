...
values (:fname,:lname,:email,:sex,:dbirth,:adid,:hp)";
    ...
    public static function findByUsername(string $username):?array{
      ...
      public static function profileData(int $userId):array{
         $db=Database::getInstance();
         $sql="select p.userId,p.firstName,p.lastName,p.email,p.sex,p.dateOfBirth,i.imageName,i.url,pd.acTypeId,aty.acTypeName,pd.accountStatus,pd.registrationDate
