    ...
    <div id="container">
        <div class="form-box">
            <table>
                ...
                <div class="paginator">
                <a href="?page=admin/banned_users_search&pag=<?= 1 ?>">First</a>
                  <?php if ($page != 1): $previous = $page - 1; ?>
                        <a href="?page=admin/banned_users_search&pag=<?= $previous ?>">&laquo; Previous</a>
                    <?php else: ?>
                    ...
                    ?>
                        <?php if ($i == $page): ?>
                            <a href="?page=admin/banned_users_search&pag=<?= $i ?>" class="activepage"><?= $i ?></a>
                        <?php else: ?>
                            <a href="?page=admin/banned_users_search&pag=<?= $i ?>"><?= $i ?></a>
                        <?php endif; ?>
                    <?php endfor; ?>

                                        <?php if ($page < $total_pages): $next = $page + 1; ?>

                        <a href="?page=admin/banned_users_search&pag=<?= $next ?>"> Next &raquo;</a>
                    <?php else: ?>
                        <a href="" class="disabled"> Next &raquo;</a>

                    <?php endif; ?>
                    <a href="<?= "?page=admin/banned_users_search&pag=" . $total_pages . "" ?>"> Last</a>
        </div>
           <?php endif; ?>
        </div>
</main>